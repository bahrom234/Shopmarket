              ...
              <div class="card-body center" style="width: 1400px;"> 
                <table>
                  <tr style="border: 3px #00aaff solid;">
                    ...
                    <td class="td" style="border: 3px #00aaff solid; width:250px; text-align:center;">Img</td>
                    <td class="td" style="border: 3px #00aaff solid; width:450px; text-align:center;">Title</td>
                    <td class="td" style="border: 3px #00aaff solid; width:450px; text-align:center;">Price</td>
                    <td class="td" style="border: 3px #00aaff solid; width:450px; text-align:center;">Priced</td>
                    <td class="td" style="border: 3px #00aaff solid; width:450px; text-align:center;">Remove Img</td>
                    <td class="td" style="border: 3px #00aaff solid; width:450px; text-align:center;">Remove</td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; text-align:center;">Add</td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; text-align:center;">Delete</td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; text-align:center;">Update</td>
                  </tr>
                  <?
                  ...
                  <tr style="border: 3px #00aaff solid;">
                    ...
                    <td style="border: 3px #00aaff solid; text-align:center;">
                      <img src="./BD/images/<?=$lang['img']?>" alt="img" style="width: 40px; height: 40px; border-radius:50%;">
                    </td> 
                    ...
                    <td class="td" style="border: 3px #00aaff solid; text-align:center;"><?=$lang['priced']?></td>
                    <td style="border: 3px #00aaff solid; text-align:center;">
                      <img src="./BD/images/<?=$lang['removeimg']?>" alt="img" style="width: 40px; height: 40px; border-radius:50%;">
                    </td> 
                    <td class="td" style="border: 3px #00aaff solid; text-align:center;"><?=$lang['remove']?></td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; color:black; text-align:center; text-decoration:none;">
                      <a href="./BD/shcart_add.php">ADD</a>
                    </td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; color:black; text-align:center; text-decoration:none;">
                      <a href="./BD/shcart_delete.php?id=<?=$lang['id']?>">Delete</a>
                    </td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; color:black; text-align:center; text-decoration:none;">
                      <a href="./BD/shcart_update.php?id=<?=$lang['id']?>">Update</a>
                    </td>
