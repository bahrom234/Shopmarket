                ...
                <table>
                  ...
                  <tr style="border: 3px #00aaff solid;">
                    ...
                    <td class="td" style="border: 3px #00aaff solid; width:250px; color:black; text-align:center; text-decoration:none;">
                      <a href="./BD/header_sec_add.php">ADD</a>
                    </td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; color:black; text-align:center; text-decoration:none;">
                      <a href="./BD/header_sec_delete.php?id=<?=$lang['id']?>">Delete</a>
                    </td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; color:black; text-align:center; text-decoration:none;">
                      <a href="./BD/header_sec_update.php?id=<?=$lang['id']?>">Update</a>
                    </td>
                  </tr>
