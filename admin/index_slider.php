              ...
              <div class="card-body center" style="width: 1400px;"> 
                <table>
                  ...
                  <tr style="border: 3px #00aaff solid;">
                    ...
                    <td class="td" style="border: 3px #00aaff solid; width:450px; text-align:center;" ><?=$lang['hreftext']?></td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; color:black; text-align:center; text-decoration:none;">
                      <a href="./BD/indexs_add.php">ADD</a>
                    </td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; color:black; text-align:center; text-decoration:none;">
                      <a href="./BD/indexs_delete.php?id=<?=$lang['id']?>">Delete</a>
                    </td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; color:black; text-align:center; text-decoration:none;">
                      <a href="./BD/indexs_update.php?id=<?=$lang['id']?>">Update</a>
                    </td>
                  </tr>
