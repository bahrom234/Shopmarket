  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">About Text First</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body center" style="width: 1400px;"> 
                <table>
                  <tr style="border: 3px #00aaff solid;">
                    ...
                    <td class="td" style="border: 3px #00aaff solid; width:250px; text-align:center;">Title</td>
                    <td class="td" style="border: 3px #00aaff solid; width:450px; text-align:center;" >Text</td>
                    <td class="td" style="border: 3px #00aaff solid; width:450px; text-align:center;">Text Second</td>
                  ...
                  <tr style="border: 3px #00aaff solid;">
                    ...
                    <td class="td" style="border: 3px #00aaff solid; text-align:center;"><?=$lang['textSecond']?></td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; color:black; text-align:center; text-decoration:none;">
                      <a href="./BD/index_add.php">ADD</a>
                    </td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; color:black; text-align:center; text-decoration:none;">
                      <a href="./BD/index_delete.php?id=<?=$lang['id']?>">Delete</a>
                    </td>
                    <td class="td" style="border: 3px #00aaff solid; width:250px; text-align:center;">
                      <a href="./BD/index_update.php?id=<?=$lang['id']?>">Update</a>
                    </td>
                  </tr>
