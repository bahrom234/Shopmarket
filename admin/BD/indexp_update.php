    ...
    <table>   
        <form action="update.php" method="post" class="form" enctype="multipart/form-data">
            <tr class="tr">
                ...
                <td class="td">Href</td>
                <td class="td">Img</td>
                <td class="td">Href Second</td>
                <td class="td">Title</td>
                <td class="head_right">Price</td>
            </tr>
            <?
            $id = $_GET['id'];
            $select = mysqli_query($bd, "SELECT * FROM `indexproduct` WHERE `id`='$id'");
            ...
            <tr class="tr" >
                ...
                <td class="td">
                    <input type="text" name="hrefsecond" class="input" value="<?= $lang['hrefsecond'] ?>">
                </td>
                <td class="td">
            ...
            <tr>
                ...
                <td class="td"></td>
                <td class="foot_right">
                    <input type="submit" name="indexp" value="Update" class="button" >
                </td>
            </tr>
        </form>
    </table>
