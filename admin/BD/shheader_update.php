    ...
    <table>
        <form action="update.php" method="post" class="form">
           <tr class="tr">
                ...
                <td class="head_right">Title</td>
            </tr>
            <?
            $id = $_GET['id'];
            $select = mysqli_query($bd, "SELECT * FROM `shopheader` WHERE `id`='$id'");
            ...
            <tr>
                ...
                <td class="foot_right"><input type="submit" class="button_big" name="shheader"></td>
            </tr>
