    ...
    <table>
        <form action="update.php" method="post" class="form">
           <tr class="tr">
                ...
                <td class="td">Text</td>
                <td class="head_right">Text Second</td>
            </tr>
            <?
            $id = $_GET['id'];
            $select = mysqli_query($bd, "SELECT * FROM `abouttextone` WHERE `id`='$id'");
            ...
            <tr class="tr">
                ...
                <td class="td">
                    <input type="text" name="textSecond" class="input" value="<?= $lang['textSecond'] ?>">
                </td>
            </tr>
            <tr>
                ...
                <td class="td"></td>
                <td class="td"></td>
                <td class="foot_right"><input type="submit" class="button_big" name="index"></td>
            </tr>
