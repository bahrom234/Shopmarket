    ...
    <table>
        <form action="update.php" method="post" class="form">
           <tr class="tr">
            ...
            <?
            $id = $_GET['id'];
            $select = mysqli_query($bd, "SELECT * FROM `faqstext` WHERE `id`='$id'");
            ...
            <tr class="tr">
                ...
                <td class="td">
                    <input type="text" name="hreftext" class="input" value="<?= $lang['hreftext'] ?>">
                </td>
            </tr>
            <tr>
                ...
                <td class="td"></td>
                <td class="td"></td>
                <td class="foot_right"><input type="submit" class="button_big" name="faqstext"></td>
            </tr>
