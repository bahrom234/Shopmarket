              ...
              <div class="card-body center" style="width: 1400px;">
                <table>
                  <tr style="border: 3px #00aaff solid;">
                    ...
                    <td class="td" style="border: 3px #00aaff solid; width:180px; text-align:center;">Img</td>
                    <td class="td" style="border: 3px #00aaff solid; width:440px; text-align:center;">Text</td>
                    <td class="td" style="border: 3px #00aaff solid; width:220px; text-align:center;">Title</td>
                    <td class="td" style="border: 3px #00aaff solid; width:210px; text-align:center;">Price</td>
                    <td class="td" style="border: 3px #00aaff solid; width:210px; text-align:center;">Status</td>
                    <td class="td" style="border: 3px #00aaff solid; width:400px; text-align:center;">Action</td>
                  </tr>
                  <?
                  $select = mysqli_query($bd, "SELECT * FROM `shopmarket`");
                  ...
                  ?>
                    <tr style="border: 3px #00aaff solid;">
                      ...
                      <td class="td" style="border: 3px #00aaff solid; text-align:center;"><?= $lang['text'] ?></td>
                      ...
                      <td class="td" style="border: 3px #00aaff solid; text-align:center;"><?= $lang['status'] ?></td>
                      <div class="input3" style="margin:65px auto;">
                          <form action="../post.php" method="POST">
                            <td><a href='' name="confirm">confirm</a></td>
                          </form>
                        </div>
                    </tr>
...
<a href='post.php?id=<?= $lang['id'] ?>' name="confirm" style="background-color: #<?php echo $back_green; ?>; width:110px; height:50px; border-radius:15px;">
  <? echo $num_1 ?></a></td>
<input name="holding" type="submit" value="<? echo $num_2 ?>" style="background-color: #<?php echo $back_yellow; ?>; width:110px; height:50px; border-radius:15px;">
<input name="cancel" type="submit" value="<? echo $num_0 ?>" style="background-color: #<?php echo $back_red; ?>; width:110px; height:50px; border-radius:15px;">
